...
export class DataNotFoundError extends HttpError {
  errors: any[]
  constructor(errors: any[], statusCode: number = 404) {
    super("데이터를 찾을 수 없습니다.", statusCode)
    this.errors = errors
  }
}

export class AffectedRowsError extends HttpError {
  errors: any[]
  constructor(errors: any[], statusCode: number = 404) {
...
export class DuplicateError extends HttpError {
  errors: any[]
  constructor(errors: any[], statusCode: number = 409) {
...
export class UnauthorizedError extends HttpError {
  errors: any[]
  constructor(errors: any[], message: string = "권한이 없습니다.", statusCode: number = 401) {
...
export class InternalServerError extends HttpError {
  errors: any[]
  constructor(errors: any[], message: string = "서버 내부 오류", statusCode: number = 500) {
    super(message, statusCode)
    this.errors = errors
  }
}
