...
) ENGINE=InnoDB AUTO_INCREMENT=101522 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `location` (
  ...
  CONSTRAINT `fk_location_client_branch1` FOREIGN KEY (`client_branch_id`) REFERENCES `client_branch` (`client_branch_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_location_warehouse1` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouse` (`warehouse_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-28 11:02:18
