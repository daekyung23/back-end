...
import { device_install_infoCountOrderByAggregateInputSchema } from './device_install_infoCountOrderByAggregateInputSchema';
import { device_install_infoAvgOrderByAggregateInputSchema } from './device_install_infoAvgOrderByAggregateInputSchema';
import { device_install_infoMaxOrderByAggregateInputSchema } from './device_install_infoMaxOrderByAggregateInputSchema';
import { device_install_infoMinOrderByAggregateInputSchema } from './device_install_infoMinOrderByAggregateInputSchema';
import { device_install_infoSumOrderByAggregateInputSchema } from './device_install_infoSumOrderByAggregateInputSchema';
...
export default device_install_infoOrderByWithAggregationInputSchema;
